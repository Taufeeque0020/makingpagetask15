...
function saveToCrud(event) {
    ...
    axios.post("https://crudcrud.com/api/ff45b9a0f637417cb7c9e65f0af4a8f6/JsProject",obj)
    .then((response)=>{
...
window.addEventListener("DOMContentLoaded",()=>{
    ...
    axios.get("https://crudcrud.com/api/ff45b9a0f637417cb7c9e65f0af4a8f6/JsProject")
    .then((response)=>{
...
function deleteExpense(id) {
    axios.delete(`https://crudcrud.com/api/ff45b9a0f637417cb7c9e65f0af4a8f6/JsProject/${id}`)
